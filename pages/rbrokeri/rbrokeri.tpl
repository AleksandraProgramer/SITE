			...
			<div class="row">
				<div class="col-md-12">
					<div class="section-heading text-center">
						<h2><span> <?php echo LANG_INSTATSW1D8Q2; ?></span></h2>
					</div>
				</div>
			</div>
<div class="row">
...
<div class="reviews__block facebook">
			...
			<div class="author__info">	
				<?php 
						$tstr6_1 = index::rbroker_all('brokeri');
...
<div class="brcss">			
			<?php 
				$tstr6_1A = index::rbroker_all('brokeri_table');
					while($sk6_1A = sql::fetchArray($tstr6_1A)){
						...
						echo '<tr><td colspan="4"><a href="'.$sk6_1A['link'].'" class="btn_link" target="_blank">'. LANG_DP6_MENU_GEN_CONTENT5_QWERTY4_PS_NW71 .'</a></td></tr></table>';
					}
			?>                          
</div>		
...
<div class="brcss1">			
			<?php 
				$tstr6_1AB = index::rbroker_all('brokeri_table');
					while($sk6_1AB = sql::fetchArray($tstr6_1AB)){
						...
						echo '<tr><td colspan="4"><a href="'.$sk6_1AB['link'].'" class="btn_link" target="_blank">'. LANG_DP6_MENU_GEN_CONTENT5_QWERTY4_PS_NW71 .'</a></td></tr></table>';
					}
			?>                          
</div>		
